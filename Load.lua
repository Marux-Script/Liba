do local ui = game:GetService("CoreGui"):FindFirstChild("Liba")  if ui then ui:Destroy() end end
do local ui = game:GetService("CoreGui"):FindFirstChild("LibaRightFrame")  if ui then ui:Destroy() end end
...
local Discord_Invite_Code = "maruhub"
...
local MaruCourseScreen = Instance.new("ScreenGui")
MaruCourseScreen.Parent = game:GetService("CoreGui")
MaruCourseScreen.Name = "Liba"
MaruCourseScreen.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

local LibaRightFrame = Instance.new("ScreenGui")
LibaRightFrame.Parent = game:GetService("CoreGui")
LibaRightFrame.Name = "LibaRightFrame"
LibaRightFrame.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
LibaRightFrame.Enabled = false

local UiToggle = Instance.new("Frame")

UiToggle.Name = "UI_TOGGLE"
UiToggle.Parent = LibaRightFrame
...
UiToggleImage.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=9681970193&width=0&height=0&format=png"
...
function create:Win(text,logo)
    ...
    MainFrame.Parent = MaruCourseScreen
...
JoinDiscord.MouseButton1Click:Connect(function()
        ...
        pcall(function()
            if input.KeyCode == Enum.KeyCode.RightControl then
                if library.toggledui == false then
                    ...
                    wait(.3)
                    MaruCourseScreen.Enabled = false
                else
                    library.toggledui = false
                    tween:Create(MainFrame,TweenInfo.new(0.4,Enum.EasingStyle.Back),{Size = UDim2.new(0, 550, 0, 654)}):Play()
                    MaruCourseScreen.Enabled = true
                end
            end
        end)
    end)
    ...
    NotiFrame.Parent = MaruCourseScreen
